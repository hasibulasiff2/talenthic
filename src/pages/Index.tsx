      ...
      <main className="flex-grow">
        ...
        <section className="container mx-auto px-4 py-20 relative overflow-hidden min-h-[80vh] flex items-center">
          ...
          <div className="text-center relative z-10 w-full">
            <Badge variant="secondary" className="mb-4 animate-fade-in bg-secondary/10 text-secondary">
              🚀 The Future of Work
            </Badge>
            <h1 className="text-5xl md:text-7xl font-bold mb-6 text-secondary">
              Discover Your Next{" "}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary-muted">
                Career Move
              </span>
            </h1>
            ...
            <form onSubmit={handleSearch} className="max-w-2xl mx-auto relative mb-12 animate-fade-up delay-200">
              ...
              />
              <Button type="submit" className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full w-12 h-12 p-0 bg-primary hover:bg-primary/90">
            ...
            <div className="flex justify-center gap-4 animate-fade-up delay-300">
              <Button 
                size="lg" 
                className="text-lg px-8 bg-primary hover:bg-primary/90 transition-all group shadow-lg"
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="text-lg px-8 border-2 hover:bg-secondary hover:text-white transition-all shadow-lg"
